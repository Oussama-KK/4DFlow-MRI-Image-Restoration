...
The main approach is based on **Restormer**, a Transformer architecture designed for image restoration using an efficient attention mechanism. Several Restormer configurations were implemented and compared, together with a conventional **U-Net baseline**, to study the impact of model architecture and capacity on restoration performance.
